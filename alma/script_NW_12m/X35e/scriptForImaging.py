...
split(vis=finalvis,
      spw=contspws,      
      outputvis=contvis,
      width=[1920,3840,3840,3840,1920,3840,3840,3840,1920,3840,3840,3840,1920,3840,3840,3840,1920,3840,3840,3840,1920,3840,3840,3840], # number of channels to average together. change to appropriate value for each spectral window in contspws (use listobs to find) and make sure to use the native number of channels per SPW (that is, not the number of channels left after flagging any lines)
      datacolumn='data')
...
field='4~111' # science field(s). For a mosaic, select all mosaic fields. DO NOT LEAVE BLANK ('') OR YOU WILL TRIGGER A BUG IN CLEAN THAT WILL PUT THE WRONG COORDINATE SYSTEM ON YOUR FINAL IMAGE.
...
start='-120km/s' # start velocity. See science goals for appropriate value.
width='1.46km/s' # velocity width. See science goals.
nchan = 165  # number of channels. See science goals for appopriate value.
...
start='-200km/s' # start velocity. See science goals for appropriate value.
width='1.46km/s' # velocity width. See science goals.
nchan = 200  # number of channels. See science goals for appopriate value.
outframe='lsrk' # velocity reference frame. See science goals.
veltype='radio' # velocity type. See note below.
restfreq='217.1GHz' # Typically the rest frequency of the line of
                        # interest. If the source has a significant
                        # redshift (z>0.2), use the observed sky
                        # frequency (nu_rest/(1+z)) instead of the
                        # rest frequency of the
...
lineimagename = 'source_calibrated_line_image_H2CO' # name of line image
...
outframe='lsrk' # velocity reference frame. See science goals.
veltype='radio' # velocity type. See note below.
restfreq='219.96GHz' # Typically the rest frequency of the line of
                        # interest. If the source has a significant
                        # redshift (z>0.2), use the observed sky
                        # frequency (nu_rest/(1+z)) instead of the
                        # rest frequency of the
