...
cvel(vis=se,
     outputvis='SE_merge_7m12m_SiO2-1.ms',
     field='OMC1_SE',
     spw='0,4',
     mode='velocity',
     start='-240km/s',
...
cvel(vis=nw,
     outputvis='NW_merge_7m12m_SiO2-1.ms',
     field='OMC1_NW',
...
concatvis = 'NWSE_12SiO2-1_merge_7m_12m.ms'
inputvis = ['SE_merge_7m12m_SiO2-1.ms', 'NW_merge_7m12m_SiO2-1.ms']
...
lineimagename='Orion_NWSE_12SiO2-1_merge_7m_12m'
...
lineimagename='Orion_NWSE_12SiO2-1_merge_7m_12m_longbaselinesonly'
for ext in ['.flux','.image','.mask','.model','.pbcor','.psf','.residual','.flux.pbcoverage']:
    rmtables(lineimagename+ext)
