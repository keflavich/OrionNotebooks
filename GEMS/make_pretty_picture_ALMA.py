...
if not 'fe' in locals():
    ...
    almablue_hdul = fits.open("/Users/adam/work/orion/alma/ALMA_Outflow_b6_12M_12CO.masked_moment0_blue.fits")
    almared_hdul = fits.open("/Users/adam/work/orion/alma/ALMA_Outflow_b6_12M_12CO.masked_moment0_red.fits")
...
almabluemin = 1; almabluemax = 100; almabluescale = 1.0
almaredmin = 1; almaredmax = 100; almaredscale = 1.0
